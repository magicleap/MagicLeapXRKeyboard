...
namespace MagicLeap.SetupTool.Editor.Setup
{
    ...
    public class ImportMagicLeapSdkSetupStep : ISetupStep
    {
        ...
        private const string FAILED_TO_EXECUTE_ERROR = "Failed to execute [Add Magic Leap Package]";
        ...
        public static readonly bool IsCheckingForInstalledPackage = !HasMagicLeapSdkInPackageManager && Running;
        ...
        private Action PackageImportInterrupted;
        ...
        private void AddRegistryAndImport()
        {
            ...
            void OnAddedPackage(bool success)
            {
                ...
                {
                    BusyCounter--;
                    PackageImportInterrupted?.Invoke();
                }
